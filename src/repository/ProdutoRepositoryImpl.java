...
public class ProdutoRepositoryImpl implements ProdutoRepository {
    ...
    @Override
    public int buscarEstoqueAtual(Long produtoId, Connection conn) throws SQLException {
    ...
    @Override
    public void darBaixaEstoque(Long produtoId, Integer quantidade, Connection conn) throws SQLException {
        String sql = "UPDATE produtos SET quantidade_estoque = quantidade_estoque - ? WHERE id = ?";
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setInt(1, quantidade);
            stmt.setLong(2, produtoId);
